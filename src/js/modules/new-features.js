...
var drawPrizeClicks = function(prizes){
	...
	for (var i = 0; i < prizes; i++){
		document.write("<img src=\"img/circle.icons\" id=\"prizeClick" + (i + 1) + "\" style=\"top:" + prizes_offset_top + "px; left:" + (prizes_offset_left + i*100) + "px;\" />");
	}
}(3);
...
var drawBoard = function(){
	...
	document.write(`<img id="badGuy1" src="img/tvbadguy.png" />`);
};
